    ...
    def get_catalog_configs():
        ...
        config: list[CatalogConfig] = [
            ...
            CatalogConfig(
                ...
                schema=f"discover/$type?api_key=$api_key&language=en-US&region=US&with_original_language=en&release_date.gte={premieres_previous}&release_date.lte={premieres_current}&with_release_type=1|3|2",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="premieres",
                ...
                schema=f"discover/$type?api_key=$api_key&language=en-US&region=US&with_original_language=en&sort_by=popularity.desc&include_null_first_air_dates=false&first_air_date.gte={premieres_previous}&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="trending_today",
                display_name="Trending Today",
                provider_id="tmdb",
                types=movies_series,
            ...
            CatalogConfig(
                ...
                provider_id="tmdb",
                types=movies_series,
                schema="trending/$type/week?api_key=$api_key",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="blockbusters",
                provider_id="tmdb",
                types=[CatalogType.MOVIES],
                schema="discover/$type?api_key=$api_key&language=en-US&region=US&with_original_language=en&sort_by=revenue.desc",
                expiration_days=30,
            ),
            CatalogConfig(
            ...
            CatalogConfig(
                ...
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=64|4353|244&first_air_date.lte={premieres_current}",
                expiration_days=1,
                pages=20,
            ),
            CatalogConfig(
                name_id="network_series.History",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=65&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="network_series.national_geographic",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=43&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="network_series.tlc",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=84&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="network_series.e!",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=76&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="network_series.adult_swim",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=80&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
            CatalogConfig(
                name_id="network_series.mtv",
                provider_id="tmdb",
                types=[CatalogType.SERIES],
                schema=f"discover/$type?api_key=$api_key&sort_by=popularity.desc&include_adult=false&language=en-US&region=US&with_original_language=en&include_null_first_air_dates=false&vote_average.gte=3&with_networks=33&first_air_date.lte={premieres_current}",
                expiration_days=1,
            ),
        ]
